...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .error-code { font-size: 120px; font-weight: 900; background: linear-gradient(135deg, #4F46E5, #7C3AED); -webkit-background-clip: text; -webkit-text-fill-color: transparent; line-height: 1; }
...
<body>
    <div class="container">
        ...
        <p class="error-desc">You need to be authenticated to access this page. Please log in and try again.</p>
        <div>
